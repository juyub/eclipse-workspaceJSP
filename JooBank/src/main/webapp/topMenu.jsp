...
function toggleSubMenu(show) {
 ...
 <link rel="stylesheet" type="text/css" href="/JooBank/css/topmenu.css">
    ...
    <td class="cell4" align="center">
      <ul>
        <li id="menu4" onmouseover="toggleSubMenu(true)" onmouseout="toggleSubMenu(false)">
          <img src="/JooBank/image/user.png" id="li-image" alt="로고">
          <ul id="submenu4">
            <c:choose>
              <c:when test="${ empty login }">
                <li><a href="/JooBank/user/join.jsp">회원가입</a></li>
