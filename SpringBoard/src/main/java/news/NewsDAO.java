...
public class NewsDAO {
	...
	static {
	    ...
	    try {
	        // 변경된 부분
	        ClassLoader classLoader = NewsDAO.class.getClassLoader();
...
public List<NewsVO> findNews() {
        ...
        try {
            ...
            if (responseEntity.getStatusCode().is2xxSuccessful()) {
                ...
                List<NewsVO> newsList = mapper.readValue(itemsNode.toString(), new TypeReference<List<NewsVO>>() {});
